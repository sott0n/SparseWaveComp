...
// RUN: not sparsewave-opt %s \
// RUN:   --convert-sparsewave-to-gpu='position-block-size=48 wave-size=32' \
...
// INVALID-WAVE-BLOCK-SIZE: wave position mapping requires the position block size to be a multiple of the wave size, but got 48 and 32
